...
const PREVIEW_MESSAGE = [
  ...
  { id: 2, content: "I am doing great! just working on some new fetures.", isSent: true },
];
  ...
  return (
    <div className="h-auto container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
        ...
        <div className="rounded-xl border border-base-300 overflow-hidden base-bg-100 shadow-lg">
